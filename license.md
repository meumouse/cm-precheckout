...
This End-User License Agreement ("Agreement") is a legal agreement between you (either an individual or an entity) and MeuMouse.com ("Licensor") for the use of the software CM Pré-checkout ("Software").
